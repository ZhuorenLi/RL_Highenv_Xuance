...
def parse_args():
    parser = argparse.ArgumentParser("Use sac_CHD of XuanCe for highway.")
    parser.add_argument("--env-id", type=str, default="highway-v0")
    parser.add_argument("--test", type=int, default=0)
    parser.add_argument("--method", type=str, default="sac_CHD")
...
if __name__ == "__main__":
    parser = parse_args()
    configs_dict = get_configs(file_dir="sac_CHD_highway.yaml")
    ...
    if not configs.test:
        ...
        Agent.load_model(path=Agent.model_dir_load, model='sac_CHD')
